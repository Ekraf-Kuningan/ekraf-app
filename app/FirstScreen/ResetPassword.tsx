...
import { View, Text, TextInput, TouchableOpacity, SafeAreaView, StatusBar, useColorScheme } from 'react-native';
  ...
  return (
    <SafeAreaView className={`flex-1 pt-2 ${isDark ? 'bg-black' : 'bg-white'}`}>
      ...
      <View className="p-6">
        ...
        <TouchableOpacity
          className={`rounded-lg py-4 ${isDark ? 'bg-yellow-600' : 'bg-yellow-500'}`}
